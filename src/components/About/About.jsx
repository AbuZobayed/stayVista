        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12">
          ...
          <div className="relative">
            <img
              ...
              src="https://images.unsplash.com/photo-1674885674913-f731091b92fa?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold">
              Discover Your Perfect Stay in Bangladesh
            </h3>
            <p className="text-gray-600">
              At StayVista, we're passionate about connecting travelers with
              unique and comfortable accommodations across Bangladesh. From
              serene beaches to historic landmarks, we offer a curated selection
              of properties that showcase the best of Bangladeshi hospitality.
            </p>
